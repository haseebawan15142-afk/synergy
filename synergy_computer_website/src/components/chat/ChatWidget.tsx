...
const welcome: Message = {
  ...
  role: "assistant",
  content:
    "Hi — I'm Synergy Assistant. Ask about our services, technology partners, industries, or how to get a quote. For urgent help, visit Contact or call our Karachi office.",
};
