...
import type { SocialPlatform } from "@/lib/content/social-links";
...
function TikTokIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.3 6.34 6.34 0 009.5 21.64a6.34 6.34 0 006.34-6.34V8.73a8.19 8.19 0 004.85 1.57V6.86a4.84 4.84 0 01-1.1-.17z" />
    </svg>
  );
}
...
const PLATFORM_ICONS: Record<SocialPlatform, (props: IconProps) => ReactNode> = {
...
export function SocialPlatformIcon({
  ...
  if (custom) {
    return (
      ...
      <img src={custom} alt="" className={`${className} object-contain`} width={20} height={20} />
    );
  }
  const Icon = PLATFORM_ICONS[platform] || GenericLinkIcon;
